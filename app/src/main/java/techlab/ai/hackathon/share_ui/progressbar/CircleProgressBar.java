...
//        final TypedArray a = context.obtainStyledAttributes(attrs, com.liihuu.progressbar.R.styleable.circleProgressBar);
//        textSize = a.getDimension(com.liihuu.progressbar.R.styleable.circleProgressBar_textSize, dip2px(15));
//        progressWidth = a.getDimension(com.liihuu.progressbar.R.styleable.circleProgressBar_progressWidth, dip2px(3));
//        smallCircleColor = a.getColor(com.liihuu.progressbar.R.styleable.circleProgressBar_smallCircleColor, 0xffffffff);
//        a.recycle();
//    }
//
//    @Override
